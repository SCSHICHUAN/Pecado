/**
 * @file document.js
 * 【功能】SKILL.md 文档：frontmatter、Instructions/Resources、导入描述
...
function normalizeDocMeta(meta = {}) {
  ...
  if (next.resourceFolderSource != null) {
    next.resourceFolderSource = String(next.resourceFolderSource).trim();
  }
  if (next.hasResourceFiles != null) {
    next.hasResourceFiles = Boolean(next.hasResourceFiles);
  }
